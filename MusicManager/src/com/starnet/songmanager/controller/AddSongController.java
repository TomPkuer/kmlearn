...
@Controller
public class AddSongController implements org.springframework.web.servlet.mvc.Controller{
	...
	@RequestMapping(value="/addSongController.do")
    ...
    public ModelAndView handleRequest(HttpServletRequest arg0, HttpServletResponse arg1) throws Exception {
		...
		int ret=songService.addSong(songInfo);
