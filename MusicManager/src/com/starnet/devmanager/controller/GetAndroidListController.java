...
@Controller
public class GetAndroidListController implements org.springframework.web.servlet.mvc.Controller{
	...
	@RequestMapping(value="/getAndroidListController.do")
    
    @Override
    public ModelAndView handleRequest(HttpServletRequest arg0, HttpServletResponse arg1) throws Exception {
        arg1.setHeader("Content-type","text/html;charset=UTF-8");
        JSONArray jsonArray=new JSONArray();
         jsonArray.addAll(devService.listAll(0));
